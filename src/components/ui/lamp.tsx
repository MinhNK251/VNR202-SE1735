  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br text-white from-slate-300 to-slate-500 bg-clip-text text-center text-2xl sm:text-6xl md:text-4xl lg:text-7xl font-medium tracking-tight text-transparent"
      >
        Diễn biến chính
      </motion.h1>
    </LampContainer>
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-auto flex-col items-center justify-center overflow-hidden bg-slate-950 w-full z-0",
        className
      )}
    >
      ...
      <div className="relative z-50 flex -translate-y-80 flex-col items-center px-5 mt-60">
        {children}
      </div>
    </div>
  );
